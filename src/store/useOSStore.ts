...
const DEFAULT_STATE: OSState = {
  ...
  wallpaperId: (typeof window !== 'undefined' && localStorage.getItem('ios_wallpaper_id')) || 'dynamic-aurora',
  lockWallpaperId: (typeof window !== 'undefined' && localStorage.getItem('ios_lock_wallpaper_id')) || 'dynamic-aurora',
...
export const useOSStore = () => {
  ...
  const toggleControlCenter = () => {
    ...
    setOSState((prev) => ({
      ...prev,
      isControlCenterOpen: !prev.isControlCenterOpen,
      isSpotlightOpen: false
    }));
  };
