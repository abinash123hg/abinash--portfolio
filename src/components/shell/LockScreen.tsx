...
export const LockScreen: React.FC = () => {
  const { toggleLock, openApp, lockWallpaperId, notifications } = useOSStore();
  ...
  return (
    <motion.div
      ...
      className={`absolute inset-0 z-40 flex flex-col justify-between p-6 pt-14 pb-8 ${lockWallpaper.className} text-white select-none overflow-hidden`}
    >
