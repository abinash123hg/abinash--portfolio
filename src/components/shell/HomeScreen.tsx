...
export const HomeScreen: React.FC = () => {
  ...
  return (
    <div
      ...
      className="relative flex-1 min-h-0 w-full flex flex-col justify-between pb-20 px-3 select-none overflow-hidden"
      style={{ paddingTop: 72 }}
    >
      <AnimatePresence>
        {isHomeEditing && (
        ...
        <div className="grid grid-cols-4 gap-y-4 gap-x-2 px-1 justify-items-center">
          ...
          {homePageIndex === 1 && (
            ...
            >
              ...
              <span className="text-[11px] font-semibold tracking-tight" style={nameStyle}>
                Dev Tools
              </span>
            </motion.div>
          )}
