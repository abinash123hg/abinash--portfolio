      ...
      <AnimatePresence>
        {activeProject && (
          <motion.div
            ...
            className="fixed inset-0 z-50 bg-zinc-950 text-white flex flex-col overflow-y-auto no-scrollbar"
          >
            {/* Detail Navigation Header */}
            <div className="sticky top-0 z-30 p-3 bg-zinc-900/90 backdrop-blur-xl border-b border-white/10 flex items-center justify-between">
              <button
