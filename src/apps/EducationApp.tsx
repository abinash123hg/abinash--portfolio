          ...
          >
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-sm font-bold tracking-tight text-white">{edu.degree}</h3>
                  {edu.specialization && (
            ...
            <div className="mt-3 pt-2.5 border-t border-white/10 space-y-1.5 text-xs text-zinc-300">
