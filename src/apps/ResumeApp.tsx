...
export const ResumeApp: React.FC = () => {
  ...
  const handleDownload = () => {
    ...
    // Create a structured printable summary file download
    const content = `ABINASH SWAIN
AI/ML Developer | LLM & RAG Systems
...
- B.Tech in Computer Science & Engineering (AI & ML)
  Centurion University of Technology and Management (CUTM), 2024–Present
  CGPA: 8.32 / 10.0

CORE PROJECTS:
1. MLOps & Autonomous Data Agent with MCP
   Technologies: Python, FastMCP, ChromaDB, Ollama, Scikit-learn, Streamlit
   - Automated profiling, model training, evaluation and local Ollama RAG integration.

2. DocuRAG — Multimodal Document RAG & Knowledge Engine
   Technologies: LlamaIndex, Qdrant, ChromaDB, FlashRank, BM25, FastAPI
   - Context Precision: 94.2%, Latency: <580ms, 42% Hallucination reduction.

3. TeamCopilot — Autonomous Engineering & Support Copilot
   Technologies: LangGraph, FastAPI, pgvector, Redis, Tool Calling
   - MTTA Reduction: 68%, Tool Calling Accuracy: 96.8%.

4. NeuralRank & Explain
   Technologies: PyTorch, Faiss, XGBoost, LambdaMART, Streamlit
   - NDCG@10: 0.892, CTR Improvement: +19.4%, Catalog: 100,000+ items.

EXPERIENCE:
- TutorialsPoint Academy — AI/ML Developer (RAG, Fine-Tuning & Deep Learning) (June 2026 – Present)
- InternPe — Data Analyst Intern (August 2026 – Present)

CERTIFICATIONS:
- Oracle Certified Associate — Agentic AI (17 August 2026)
- Adobe AI Essentials for Marketers (1 September 2026)
...
`;
    ...
    a.href = url;
    a.download = PORTFOLIO_DATA.personal.resumeFileName;
        ...
        <div className="p-5 rounded-3xl bg-zinc-900/90 border border-white/10 shadow-2xl text-left text-xs text-zinc-300 space-y-4 font-sans leading-relaxed">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-300">
              Oracle Certified Associate — Agentic AI, Adobe AI Essentials, GenAI Data Analytics (Tata/Forage), Deloitte Data Analytics, TutorialsPoint Smart Inventory ML, InternPe Data Analyst, Anthropic Claude MCP, TCS iON.
            </p>
          </div>
        </div>
      </div>
