...
export const DeviceFrame: React.FC<DeviceFrameProps> = ({ children }) => {
  ...
  return (
    <div className="iphone-shell relative h-[100dvh] min-h-0 w-full flex items-center justify-center p-0 sm:p-4 md:p-6 bg-neutral-950 font-sans antialiased overflow-hidden">
      ...
      <div className="relative w-full max-w-[430px] h-[100dvh] min-h-0 sm:h-[860px] sm:max-h-[96dvh] sm:rounded-[54px] bg-gradient-to-b from-zinc-700 via-zinc-800 to-zinc-900 p-[3px] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9),0_0_0_1px_rgba(255,255,255,0.15)] flex flex-col overflow-hidden">
